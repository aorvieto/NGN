...
#python --gpu "[2]" --config "cifar_resnet2.yml"
if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--wandb", type=bool, default=True, help="Whether to use wandb for logging. Default is True.")
    parser.add_argument("--gpu", type=str, default='[1]')
    parser.add_argument("--config", type=str, default="cifar_resnet3.yml", help="Path to the configuration YAML file.")
